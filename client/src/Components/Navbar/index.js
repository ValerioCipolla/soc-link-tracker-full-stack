  ...
  return (
    <ul>
      <li onClick={() => handleClick(1)}>
        <Link to="/Week">Week 1</Link>
      </li>
      <li onClick={() => handleClick(2)}>
        <Link to="/Week">Week 2</Link>
      </li>
      <li onClick={() => handleClick(3)}>
        <Link to="/Week">Week 3</Link>
      </li>
      <li onClick={() => handleClick(4)}>
        <Link to="/Week">Week 4</Link>
      </li>
      <li onClick={() => handleClick(5)}>
        <Link to="/Week">Week 5</Link>
      </li>
      <li onClick={() => handleClick(6)}>
        <Link to="/Week">Week 6</Link>
      </li>
      <li onClick={() => handleClick(7)}>
        <Link to="/Week">Week 7</Link>
      </li>
    </ul>
  );
}
